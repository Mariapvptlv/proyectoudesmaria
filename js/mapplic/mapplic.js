    ...
    var Mapplic = function () {
        ...
        function Tooltip() {
            ...
            this.init = function () {
                ...
                this.link = $('<a target="_blank">Más información</a>').addClass('mapplic-tooltip-link').attr('href', '#').hide().appendTo(this.el);
        ...
        function Sidebar() {
            ...
            this.init = function () {
                ...
                if (self.o.search) {
                    var titulo = $('<div>Mapa interactivo UDES</div>').addClass('mapplic-titulo').appendTo(this.el);
